...
export const STRINGS = {
  en: {
    ...
    sections: {
      ...
      certificationsKicker: "06 · Certifications",
      certificationsTitle: "Licenses & Verified Credentials",
      educationKicker: "07 · Education",
      educationTitle: "Learning & Foundations",
      faqKicker: "08 · Frequently Asked Questions",
      faqTitle: "Answers to Common Questions",
      contactKicker: "09 · Contact",
    },
